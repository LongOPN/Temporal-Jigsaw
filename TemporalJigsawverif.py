...
from datasets.UCFjigsawFullPlusCLS3 import UCFJigsawveriffull,UCFJigsawverif8, PhotoJigsawverifall,PhotoJigsawverif8, UCFJigsaw,PhotoJigsawverifallflip,PhotoJigsawver8flip
from models.c3d import C3D
from models.r3d import R3DNet
from models.r21d import R2Plus1DNet
#from models.opn import OPN
#Load the model
from models.modeljigsawcfullverif3 import VCOPN as TemporalJigsaw
#from models.modeljigsawcfullverif2 import VCOPN
...
# def order_class_index(order,clslist ):
...
def parse_args():
    ...
    parser.add_argument('--it', type=int, default=9, help='interval')
    parser.add_argument('--tl', type=int, default=9, help='tuple length')
    parser.add_argument('--gpu', type=int, default=0, help='GPU id')
    parser.add_argument('--lr', type=float, default=1e-3, help='learning rate')
    parser.add_argument('--momentum', type=float, default=9e-1, help='momentum')
    parser.add_argument('--wd', type=float, default=5e-4, help='weight decay')
    parser.add_argument('--log', type=str,default='/content/drive/My Drive/opnmodel/verifjigsawfull/', help='log directory')
    parser.add_argument('--ckpt', type=str,default='/content/drive/MyDrive/opnmodel/jigsawverif8/Verifull9/best_model_23_0.001__0.991.pt',help='checkpoint path')#default= 
    #parser.add_argument('--ckpt', type=str,default='/content/drive/MyDrive/opnmodel/jigsawverif8/Verifull9/Copy of best_model_706_0.666__0.862 keep.pt',help='checkpoint path')#default= 
    ...
    parser.add_argument('--bs', type=int, default=100, help='mini-batch size')
...
if __name__ == '__main__':
    ...
    opn = TemporalJigsaw(base_network=base, feature_size=256, tuple_len=args.tl).to(device)   
    multi_gpu=1
    if multi_gpu ==1:
    ...
    if args.mode == 'train':  ########### Train #############
        ...
        #test_dataset = PhotoJigsawverifallflip('data/images', args.cl, args.it, 'imgnetrgb60',  tl,  False,test_transforms  )
        #test_dataset = PhotoJigsawverifall('data/images', args.cl, args.it, 'imgnetrgb60',  tl,  False,test_transforms  )
        #test_dataset = PhotoJigsawver8flip('data/images/retme', args.cl, args.it, 'retme',  tl,  False,test_transforms  )
        #test_dataset = PhotoJigsawverif8('data/images', args.cl, args.it, 'imgnetrgb10',  tl,  False,test_transforms  )
        #test_dataset = UCFJigsawverif8('data/ucf101', args.cl, args.it, '013',  tl,  True,test_transforms  )
        #test_dataset =  UCFJigsawveriffull('data/hmdb51', args.cl, args.it, '01',  tl,  True,test_transforms  )
        test_dataset = PhotoJigsawverifall('/content/drive/Shareddrives/ICLR/Dataset', args.cl, args.it, '/content/drive/Shareddrives/ICLR/Dataset/retargetmefull',  tl,  False,test_transforms  )
